...
public class FeesAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler = findViewById(R.id.admin_fee_list);
        ...
        MyConfig.getProfileImage(profile_image_url,profile,FeesAdminActivity.this);

        names = getResources().getStringArray(R.array.admin_fees_functions_name);
