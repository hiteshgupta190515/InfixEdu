...
public class LibraryAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler = findViewById(R.id.admin_library_list);
        ...
        MyConfig.getProfileImage(profile_image_url,profile,LibraryAdminActivity.this);

        names = getResources().getStringArray(R.array.admin_library_functions_name);
