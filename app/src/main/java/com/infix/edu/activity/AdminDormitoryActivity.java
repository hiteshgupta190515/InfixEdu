...
public class AdminDormitoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //main recyclerview
        recyclerView = findViewById(R.id.dormitoryAdminRecyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        getAllDormitories();
        MyConfig.getProfileImage(profile_image_url,profile,AdminDormitoryActivity.this);
