...
public class TeacherClassRoutineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initRecyclerview();
        getRoutine(id,section_id,class_id);
    ...
    void getRoutine(int id,int section_id,int class_id){


        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, MyConfig.getRoutineByClassAndSection(id,class_id,section_id), null, new Response.Listener<JSONObject>() {
            @Override
