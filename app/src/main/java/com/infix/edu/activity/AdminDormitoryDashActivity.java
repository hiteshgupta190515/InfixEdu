...
public class AdminDormitoryDashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_dormitory_dash);

        images = new ArrayList<>();
        images.clear();

        recycler = findViewById(R.id.admin_dormitory_list);
        ...
        MyConfig.getProfileImage(profile_image_url,profile,AdminDormitoryDashActivity.this);

        names = getResources().getStringArray(R.array.admin_dormitory_functions_name);
