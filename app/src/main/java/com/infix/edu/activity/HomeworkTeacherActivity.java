...
public class HomeworkTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycler = findViewById(R.id.teacherHomeworkRecycler);
        ...
        MyConfig.getProfileImage(profile_image_url,profile,HomeworkTeacherActivity.this);

        names = getResources().getStringArray(R.array.teachers_homework_functions_name);
